...
export const Timeline: React.FC = () => {
  const items: TimelineItem[] = [
    ...
    },
    {
      ...
      subtitle: "省级三等奖 · 参赛作品：“职引星”",
      description: "以“职引星”大学生求职导航平台为参赛作品，参加全国大学生计算机设计大赛软件应用与开发赛道，荣获省级三等奖。比赛涵盖需求分析、原型设计、工程实现与现场答辩全流程，是对项目研发综合能力的一次全面检验。",
      type: "award",
    },
    {
      id: "3",
      ...
      subtitle: "独立全栈开发 · React + Go + MySQL",
      description: "独立完成 photolog 照片日志应用的前后端全栈开发。前端使用 React + CSS3 Grid 构建瀑布流卡片布局；后端选用 Go 语言构建高性能 REST API 服务，利用 Go 的并发模型处理图片上传与 IO 密集任务，使用 MySQL 存储照片元数据；解决了跨域（CORS）、文件上传、接口鉴权等联调难点，完整经历了产品从 0 到 1 的全链路闭环。",
      type: "project",
    },
    {
      id: "4",
